...
int j=0;
 ...
 query="update login set username='"+username+"', day='"+day+"', month='"+month+"' , year='"+year+"' , currentaddress='"+currentaddress+"' , permanentaddress='"+permanentaddress+"' , EmailAddress='"+EmailAddress+"' , password='"+password+"' where username='"+newusername+"' and password='"+newpassword+"'";
